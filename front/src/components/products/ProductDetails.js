  ...
  return (
    <Fragment>
      {loading ? <i class="fa fa-refresh fa-spin fa-3x fa-fw"></i> : (
        <Fragment>
          <MetaData title="Fashion"></MetaData>
          ...
          <div className='row d-flex justify-content-around'>
            ...
            <div className='col-12 col-lg-5 mt-5'>
              ...
              <div className="stockCounter d-inline">
                <span className="btn btn-dark btn-sm minus" onClick={decrementarQty}>-</span>
                <input type="number" className="form-control count d-inline" value={quantity} readOnly></input>
                <span className="btn btn btn-dark btn-sm plus" onClick={incrementarQty}>+</span>
              ...
              <p>Estado: <span id="stock_stado" className={product.inventario }></span></p>
              <hr />
              <h4 className="mt-2">Descripción:</h4>
              <p>{product.descripcion}</p>
              <hr />
              <p id="vendedor">Vendido por: <strong>{product.vendedor}</strong></p>
              <button id="btn_review" type="button" className="btn btn-warning btn-sm mt-4"
